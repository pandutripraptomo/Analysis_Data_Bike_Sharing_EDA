...
st.write("""
    **Selamat datang di Dashboard Analisis Penyewaan Sepeda!** 🎉
    Dashboard ini bertujuan untuk memberikan wawasan mendalam tentang **penyewaan sepeda** 🚲 berdasarkan beberapa faktor utama seperti **musim** 🌦️, **cuaca** ☀️, dan **waktu** ⏰.
